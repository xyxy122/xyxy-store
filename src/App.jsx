...
function App() {
  ...
  const games = [
    ...
    { id: 8, title: "Tekken 7", price: 10000, image: "https://media.graphassets.com/jHYvjBVjT3OnOuPQrTfs" },
    { id: 9, title: "Tekken 8", price: 10000, image: "https://akinseagleseye.com/wp-content/uploads/2024/02/tekken-8-artwork.jpg" },
    { id: 10, title: "Among Us", price: 10000, image: "https://static1.srcdn.com/wordpress/wp-content/uploads/2020/11/Among-Us-217-million.jpg" },
  ];
  ...
  useEffect(() => {
    ...
    if (lastPromo.date !== today) {
      ...
      localStorage.setItem("dailyPromo", JSON.stringify({ id: randomId, date: today }));
      setPromoId(randomId);
    } else {
    ...
    <Router>
      ...
      <Routes>
        <Route
          ...
          element={
            <>
              <DailyPoint user={user} discountActive={discountActive} setDiscountActive={setDiscountActive} />
              <HomePage
